 ...
 */
class HotScreenListAdapter(private val context: Context, private val data: MutableList<HotScreenResult.SubjectsBean>)
    : RecyclerView.Adapter<HotScreenListAdapter.ViewHolder>() {

    private lateinit var itemClick: (view: View, position: Int) -> Unit
